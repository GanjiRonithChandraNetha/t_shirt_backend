...
ADD COLUMN user_min bigint GENERATED ALWAYS AS (LEAST(followee,follower)) STORED,
ADD COLUMN user_max bigint GENERATED ALWAYS AS (GREATEST(followee,follower)) STORED;

ALTER TABLE followers
ADD CONSTRAINT unique_follow_pair UNIQUE(user_min,user_max);
-- =====================================================
-- 6. PAYMENTS  (FIX #11)
-- =====================================================
